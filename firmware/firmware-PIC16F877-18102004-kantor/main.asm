...
; Update History: 
; 1.12.2003 initial build 0.01a
; 10.12.2003 first release 0.01
; 10.1.2004  0.1 added serial interrupt, debuuged timer int
; 
...
; 2.) Header Includes                                                                                                                                                                                                    
	...
	include "p16F877A.inc"     ; Prozessor defs 
